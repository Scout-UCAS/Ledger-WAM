...
> This checkout also contains a causal-debt-aware Ledger-WAM extension. See
> [LEDGER_WAM.md](LEDGER_WAM.md) for architecture, annotation, training,
> evaluation, and ablation instructions.
